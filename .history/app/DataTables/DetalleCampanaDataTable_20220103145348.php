...

{
...

    {
        ...
        if(!empty($key)){
            ...
            $detalle_campanas = DetalleCampana::query()->where('detalle_campanas.marca_id', $key)->with('marca', 'vins')->orderBy('detalle_campanas.id','desc') && EstadoCampana::query()->where('vins.marca_id', $key)->with('marca', 'vins')->orderBy('vins.id','desc');

        }else{

            $detalle_campanas = DetalleCampana::query()->with('marca', 'vins')->orderBy('detalle_campanas.id','desc') && EstadoCampana::query()->with('marca', 'vins')->orderBy('vins.id','desc'); 

        }


        return $this->applyScopes($detalle_campanas && $estado_campanas);
