...
class HistorialBusquedasDataTable extends DataTable

{
    ...
    {
        //echo "sssssssss";
        $vins = Historial_busqueda::where('marca_id', 4)
                ->whereNotNull('campana')
                ->groupBy('texto_busqueda', 'campana')
                ->orderBy('created_at', 'desc')
                ->selectRaw('count(*) as cantidad_consultas, texto_busqueda, campana, "Volkswagen T&B" as marca_id, created_at');
