...
<div class="login-box">
    ...
    <div class="login-box-body">
        <h4 class="login-box-msg">Ingrese email para restablecer la contraseña:</h4>
        ...
        <form method="post" action="{{ url('/password/email') }}">
            ...
            <div class="form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
                <input type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="Su email">
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary pull-right">
                        <i class="fa fa-btn fa-envelope"></i> Enviar enlace a email
                    </button>
                </div>
            </div>
